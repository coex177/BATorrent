...
QtObject {
    ...
    readonly property var sections: [
        ...
        [
            ...
            { type: "number", key: "chipCycleSec", label: (i18n.language, i18n.t("set_chip_cycle")), value: "5", suffix: "s", note: (i18n.language, i18n.t("set_chip_cycle_note")) },
            { type: "disks", key: "monitoredDisks", label: (i18n.language, i18n.t("set_monitored_disks")), note: (i18n.language, i18n.t("set_monitored_disks_note")) },
            { type: "number", key: "diskCycleSec", label: (i18n.language, i18n.t("set_disk_cycle")), value: "5", suffix: "s", note: (i18n.language, i18n.t("set_disk_cycle_note")) },
            { type: "toggle", key: "denseRows", label: (i18n.language, i18n.t("set_dense_rows")), note: (i18n.language, i18n.t("set_dense_rows_note")) },
            { type: "toggle", key: "scrollbarsAlwaysOn", label: (i18n.language, i18n.t("set_scrollbars_always")), note: (i18n.language, i18n.t("set_scrollbars_always_note")) },
            ...
            { type: "path", key: "torrentMoveDir", label: (i18n.language, i18n.t("set_torrent_move_dir")), note: (i18n.language, i18n.t("set_torrent_move_dir_note")) },
